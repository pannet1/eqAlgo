...
def hello_world():
    ...
    http://127.0.0.1:8181/copy/NIFTY2262315500CE/NIFTY2262315500PE?p=0.5 <br>
...
def modify(varargs):
    """
    modify pending and open orders 
    """
    responses = []
